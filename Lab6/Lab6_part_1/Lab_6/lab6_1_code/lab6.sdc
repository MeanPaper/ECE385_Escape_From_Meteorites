...
create_clock -name clk_50 -period "50.0 MHz" [get_ports MAX10_CLK1_50]
...
set_input_delay -clock clk_dram_ext -max 5.9 [get_ports {DRAM_DQ*}]
set_input_delay -clock clk_dram_ext -min 3.0 [get_ports {DRAM_DQ*}]
# set_input_delay -clock clk_50 -max 5.9 [get_ports {Key*}]
# set_input_delay -clock clk_50 -min 3.0 [get_ports {Key*}]
...
set_output_delay -max -clock clk_dram_ext 1.6  [get_ports {DRAM_UDQM}]
set_output_delay -min -clock clk_dram_ext -0.9 [get_ports {DRAM_UDQM}]
