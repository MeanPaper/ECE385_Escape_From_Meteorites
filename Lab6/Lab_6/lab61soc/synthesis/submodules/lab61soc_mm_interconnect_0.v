...
module lab61soc_mm_interconnect_0 (
	...
	wire          cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> key_1_s1_agent:cp_valid
	wire  [105:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> key_1_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // key_1_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [8:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> key_1_s1_agent:cp_channel
	wire          cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> key_1_s1_agent:cp_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> key_1_s1_agent:cp_endofpacket
	...
	wire          cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> key_0_s1_agent:cp_valid
	wire  [105:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> key_0_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // key_0_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [8:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> key_0_s1_agent:cp_channel
	wire          cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> key_0_s1_agent:cp_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> key_0_s1_agent:cp_endofpacket
	...
	wire          key_1_s1_agent_rp_valid;                                                            // key_1_s1_agent:rp_valid -> router_008:sink_valid
	wire  [105:0] key_1_s1_agent_rp_data;                                                             // key_1_s1_agent:rp_data -> router_008:sink_data
	wire          key_1_s1_agent_rp_ready;                                                            // router_008:sink_ready -> key_1_s1_agent:rp_ready
	wire          key_1_s1_agent_rp_startofpacket;                                                    // key_1_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          key_1_s1_agent_rp_endofpacket;                                                      // key_1_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire          key_0_s1_agent_rp_valid;                                                            // key_0_s1_agent:rp_valid -> router_009:sink_valid
	wire  [105:0] key_0_s1_agent_rp_data;                                                             // key_0_s1_agent:rp_data -> router_009:sink_data
	wire          key_0_s1_agent_rp_ready;                                                            // router_009:sink_ready -> key_0_s1_agent:rp_ready
	wire          key_0_s1_agent_rp_startofpacket;                                                    // key_0_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          key_0_s1_agent_rp_endofpacket;                                                      // key_0_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire          key_1_s1_agent_rdata_fifo_src_valid;                                                // key_1_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] key_1_s1_agent_rdata_fifo_src_data;                                                 // key_1_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          key_1_s1_agent_rdata_fifo_src_ready;                                                // avalon_st_adapter_006:in_0_ready -> key_1_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> key_1_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> key_1_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                                  // key_1_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> key_1_s1_agent:rdata_fifo_sink_error
	wire          key_0_s1_agent_rdata_fifo_src_valid;                                                // key_0_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] key_0_s1_agent_rdata_fifo_src_data;                                                 // key_0_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire          key_0_s1_agent_rdata_fifo_src_ready;                                                // avalon_st_adapter_007:in_0_ready -> key_0_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_007_out_0_valid;                                                  // avalon_st_adapter_007:out_0_valid -> key_0_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                                   // avalon_st_adapter_007:out_0_data -> key_0_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                                  // key_0_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                                  // avalon_st_adapter_007:out_0_error -> key_0_s1_agent:rdata_fifo_sink_error
