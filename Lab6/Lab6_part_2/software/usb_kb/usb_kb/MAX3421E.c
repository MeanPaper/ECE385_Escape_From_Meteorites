...
void MAXreg_wr(BYTE reg, BYTE val) {
	...
	BYTE temp = reg + 2;
	BYTE write_in[2] = {temp, val};
	int return_code = alt_avalon_spi_command(SPI_0_BASE,0, 2, write_in ,0,NULL,0);
	if (return_code < 0) {
		printf("Error!\n");
	}
//	BYTE temp = reg + 2;
//	int return_code = alt_avalon_spi_command(SPI_0_BASE,0, 1, &temp ,0,NULL,
...
BYTE* MAXbytes_wr(BYTE reg, BYTE nbytes, BYTE* data) {
	...
	int return_code = alt_avalon_spi_command(SPI_0_BASE, 0, nbytes+1, wr_data, 0, 0, 0);
...
//	BYTE read;
//	BYTE temp = reg;
//	int return_code = alt_avalon_spi_command(SPI_0_BASE, 0, 1, &temp, 0, NULL, ALT_AVALON_SPI_COMMAND_MERGE);
//	if(return_code < 0){
//		printf("Error!\n");
//		return -1;
//	}
//	return_code = alt_avalon_spi_command(SPI_0_BASE, 0, 0, NULL, 1, &read, 0);
//	if(return_code < 0){
//		printf("Error!\n");
//		return -1;
//	}
